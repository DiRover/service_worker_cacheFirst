...
var workbox_routing_version = __webpack_require__(9080);
...
var workbox_precaching_version = __webpack_require__(7977);
...
var workbox_strategies_version = __webpack_require__(6873);
...
;// CONCATENATED MODULE: ./src/js/service.worker.js
...
precacheAndRoute([{'revision':'88caffceef57b6f52dd14cee6f301a55','url':'./index.html'},{'revision':'78f9c2af37ce4b4739fb00023fb3d255','url':'main.css'},{'revision':'79f75316d71cfeff358fe07f96d45405','url':'main.js'}]); //необязательная строка, нужна для кэширования файлов

var CACHE_NAME = 'v1'; //имя кэша

var responseCache = new Response(JSON.stringify(cinemaNews)); //для записи в кэш, т.к. это инфа из файла, а не сам файл, то из неё нужно создать запрос
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            cache = _context.sent;
            _context.next = 5;
            return cache.put(url, responseCache);
...
self.addEventListener('fetch', function (evt) {
  //отлавливаем событие фетч
  var requestUrl = new URL(evt.request.url); //получаем адрес, по которому отправился запрос

  if (!requestUrl.pathname.startsWith('/news')) return; //если это не нужный для кэширования путь, то выходим

  evt.respondWith(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  ...
  evt.waitUntil(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var client, response, json;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            //ждём пока ответ всё же придёт от сервера
            console.log('waitUntil');
            _context3.next = 3;
            return clients.get(evt.clientId);
