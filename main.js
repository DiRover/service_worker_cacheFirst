...
;// CONCATENATED MODULE: ./node_modules/@fractalsoftware/random-avatar-generator/src/index.js
...
function getAvatarFromData(avatarData, renderMethod = 'square', size = 256, avatarDataSeparator = '-') {
...
;// CONCATENATED MODULE: ./src/js/getPage.js
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }
 ...
 //библиотека для рандомных аватаров
...
var getPage = /*#__PURE__*/function () {
  ...
  _createClass(getPage, [{
    key: "fetchData",
    value: function () {
      var _fetchData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
        var response, data;
    ...
    key: "render",
    value: function render(data, blank) {
      ...
      data.forEach(function (i) {
        ...
        if (blank) {
          ...
          elem = "\n                <img src= data:image/svg+xml;base64,".concat(btoa(avatar), " alt='avatar'/>\n                ");
        }

        filmBox.innerHTML = "\n            <div class = 'film-name ".concat(blank, "'>").concat(i.name, "</div>\n            <div class = 'film-body'>\n                ").concat(elem, "\n                <div class = 'film-text'>\n                    <div class = 'text ").concat(blank, "'><span class = 'genre ").concat(blank, "'>Genre:</span> ").concat(i.genre, "</div>\n                    <div class = 'text ").concat(blank, "'><span class = 'description ").concat(blank, "'>description:</span> ").concat(i.description, "</div>\n                </div>\n            </div>\n            ");
    ...
    value: function renderError() {
      //метод для отрисовки ошибки об отсутсвии соединения
...
;// CONCATENATED MODULE: ./src/js/constans.js
//export const url = 'http://localhost:7070/news';//это нужно чтобы апп.дж не выполнялось в контексте сервис воркера
var url = 'https://unionserver.herokuapp.com/news'; //это нужно чтобы апп.дж не выполнялось в контексте сервис воркера
//иначе будет документ нот дэфайнед
...
var container = document.querySelector('.container'); //получаем контейнер для отрисовки

var page = new getPage(container); //создаём инстанс класса для рендера содержимого

if (navigator.serviceWorker) {
  //проверяем поддержку браузером сервис воркера
  window.addEventListener('load', /*#__PURE__*/app_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 5:
            ...
            console.log(_context.t0); //ловим ошибку
